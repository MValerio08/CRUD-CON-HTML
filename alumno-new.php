...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box nav-lateral">
			...
			<div class="full-box nav-lateral-content">
				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						<li>
							<a href="index.php"><i class="fab fa-dashcube fa-fw"></i> &nbsp; Dashboard</a>
						</li>
		...
		<section class="full-box page-content">
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="alumno-agregar.php" class="form-neon" autocomplete="off" method="POST">
					<fieldset>
							...
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ci" class="bmd-label-floating">C.I.</label>
										<input type="text" pattern="[a-zA-Z0-9-]{1,27}" class="form-control" name="ci" id="ci" maxlength="27">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="apellido" class="bmd-label-floating">Apellido Paterno</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="apellido" id="apellido" maxlength="40">
									</div>
								</div>
                <div class="col-12 col-md-4">
									<div class="form-group">
										<label for="apellido_mat" class="bmd-label-floating">Apellido Materno</label>
										<input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ#- ]{1,150}" class="form-control" name="apellido_mat" id="apellido_mat" maxlength="150">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
