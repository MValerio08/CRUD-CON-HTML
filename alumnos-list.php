	...
	<main class="full-box main-container">
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li>
									<a href="alumnos-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Lista de clientes</a>
								</li>
								<li>
		...
		<section class="full-box page-content">
            ...
            <?php
              ...
              $ver = Estudiante::ver();
              $resultados = json_decode($ver,true);
              echo '<tbody>';
              foreach($resultados as $reg){
                ...
                echo "<td>".$reg['numero_telf']."</td>";
                echo '<td>
									<a href="alumno-update.php" class="btn btn-success">
	  								<i class="fas fa-sync-alt"></i>	
									</a>
								</td>
								<td>
									
										<a href="eliminar-alumno.php?ci='.$reg['ci'].'" type="button" class="btn btn-warning">
